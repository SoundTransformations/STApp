...
def pitch_interface(master):
    ...
    master.pitch_frame.preview_pitch = customtkinter.CTkButton(master.pitch_frame,
                                       text="Play!", width=3,
                                       command=lambda: UF.wavplay(master.pitch_frame.filelocation_pitch.get()),
    ...
    master.pitch_frame.right_limit_pitch.grid(row=3, column=0, pady=(45, 0), padx=120, sticky="nw")
    ...
    master.pitch_frame.left_limit_pitch.grid(row=3, column=0, pady=(45, 0), padx=510, sticky="w")
